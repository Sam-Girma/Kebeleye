...
import '../../Infrastructure/auth/official_dataprovider.dart';
import '../../Infrastructure/core/Post_repository.dart';
import '../../Infrastructure/core/posts_data_provider.dart';
import '../../application/core/home_page_bloc.dart';
import '../../application/core/home_page_event.dart';
import '../../application/core/home_page_state.dart';
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                ...
                                child: ListTile(
                                  title: Text(
                                      officials.elementAt(index).officialName),
                                  subtitle: Text(
                                      officials.elementAt(index).department),
                                  onTap: () {
                                    homepagebloc2.add(FetchOfficialPostsEvent(
                                        officials.elementAt(index)));
                                  },
                                ),
                              );
                            }),
