...
import '../../Infrastructure/auth/members__dataprovider.dart';
import '../../Infrastructure/auth/official_dataprovider.dart';
import '../../application/auth/login_signup_bloc.dart';
import '../../application/auth/login_signup_event.dart';
import '../../application/auth/login_signup_state.dart';
                  ...
                  child: BlocConsumer<AuthBloc, AuthState>(
                    listener: (context, state) {
                      ...
                      if (state is LoginSuccesfulState){
                        BlocProvider.value(value: homepagebloc, child: OfficialsHomePage(),);
                      }
                      }
                    },
